...
public class ChannelListingDao extends AbstractDao{
    ...
    private final String select_by_channelSku_channelId_globalSku_id = "SELECT e FROM ChannelListing e where e.channel.id=:channelId and e.channelSkuId=:channelSkuId and e.product.globalSkuId=:globalSkuId";
