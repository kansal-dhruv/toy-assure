...
public class Constants {
  ...
  public static String MSG_INVALID_USER = "Invalid UserPojo";
  public static String MSG_INVALID_BIN_COUNT = "BinPojo count should be greater than 0";
  ...
  public static String MSG_BIN_NOT_FOUND = "Cannot find BinPojo with the given binId";
  ...
  public static String MSG_DUPLICATE_CHANNEL_ORDER_ID = "ChannelPojo order ID must be unique";
