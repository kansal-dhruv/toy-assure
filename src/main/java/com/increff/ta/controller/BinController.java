...
public class BinController {
    ...
    public ResponseEntity<Object> putProducts(@RequestParam("file") @NotNull(message = "CSV file cannot be null") MultipartFile csvfile) throws ApiException, IOException {
